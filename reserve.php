	...
	<div class="container">
		...
		if (isset($_POST['submit_reservation']) && $_SERVER['REQUEST_METHOD'] === 'POST') {
			...
			try {
				...
				$stmtClient = $con->prepare("insert into clients(full_name,client_email,client_phone,id_no,address) 
									values(?,?,?,?,?)");
				$stmtClient->execute(array($full_name, $client_email, $client_phonenumber, $id_no, $address));
					...
					<div class="col-md-5">
						<div class="client_details">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="John Paul" name="full_name" v-model='full_name'>
							...
							<div class="form-group">
								...
								<input type="email" class="form-control" name="client_email" placeholder="abc@mail.com" v-model='client_email'>
							...
							<div class="form-group">
								...
								<input type="text" name="client_phonenumber" placeholder="0722631859" class="form-control" v-model='client_phonenumber'>
							...
							<div class="form-group">
								...
								<input type="text" name="id_no" placeholder="38105483" class="form-control" v-model='id_no'>
								<div class="invalid-feedback" style="display:block" v-if="id_no === null">
							...
							<div class="form-group">
								...
								<input type="text" name="address" placeholder="Physical Address" class="form-control" v-model='address'>
								<div class="invalid-feedback" style="display:block" v-if="address === null">
									Address is required
								</div>
							</div>
							<button type="submit" class="btn sbmt-bttn" name="submit_reservation">Book Now</button>
						</div>
					</div>
				</div>
			</form>
